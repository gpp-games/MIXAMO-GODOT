...
# Option Variables:
EXPORT_ESCN = True
SAVE_INDIVIDUAL_BLENDS = True
SAVE_AS_ANIMATION_LIB = False # Not implemented, yet.
...
if filepath is '':
    ...
    if len(dat.objects) > 0:
        bpy.ops.wm.save_mainfile(filepath = filepath + ".bak")
        for obj in dat.objects:
            dat.objects.remove(obj)
